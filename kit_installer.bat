...
SET REPO_DOWNLOAD_URL=https://github.com/kandi1clickkits/Flight-Fare-Prediction/releases/download/v1.0/Flight-Fare-Prediction.zip
SET REPO_DEPENDENCIES_URL=https://github.com/kandi1clickkits/Flight-Fare-Prediction/raw/main/requirements.txt
SET REPO_NAME=Flight-Fare-Prediction.zip
SET EXTRACTED_REPO_DIR=Flight-Fare-Prediction
SET NOTEBOOK_NAME=app.py
SET DEPEN=dependency.bat
SET RUNURL=http://127.0.0.1:5000
where /q python
IF ERRORLEVEL 1 (
	ECHO==========================================================================
...
IF ERRORLEVEL 1 (
	...
	bitsadmin /transfer dependency_download_job /download %REPO_DEPENDENCIES_URL% "%cd%\requirements.txt"
	%PY_LOCATION%\python.exe -m pip install -r requirements.txt --no-deps
	ECHO==========================================================================
)
EXIT /B 0
